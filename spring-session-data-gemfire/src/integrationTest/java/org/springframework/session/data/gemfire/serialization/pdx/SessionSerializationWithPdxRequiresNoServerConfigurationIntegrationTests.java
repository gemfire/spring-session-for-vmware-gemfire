...
public class SessionSerializationWithPdxRequiresNoServerConfigurationIntegrationTests
	...
	public static void startGemFireServer() throws IOException {
		...
		String classpath = buildClassPathContainingJarFiles("javax.transaction-api", "antlr",
			...
			"geode-common", "geode-core", "geode-logging", "geode-management", "geode-membership", "geode-serialization", "geode-deployment-legacy",
			"geode-tcp-server", "jgroups", "micrometer-core", "rmiio", "shiro-core", "slf4j-api","gemfire-version");
