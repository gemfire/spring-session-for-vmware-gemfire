...
public abstract class FileUtils extends org.springframework.data.gemfire.tests.util.IOUtils {
	...
	public static void write(File file, String contents) throws IOException {
		...
		try {
			...
			org.springframework.data.gemfire.tests.util.IOUtils.close(fileWriter);
		}
	}
}
