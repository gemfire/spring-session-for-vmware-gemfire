...
tasks.named<Javadoc>("javadoc") {
    title =
        "Spring Session 3.0 for VMware GemFire ${getGemFireBaseVersion()} Java API Reference"
    isFailOnError = false
}

publishingDetails {
    artifactName.set("spring-session-3.0-gemfire-${getGemFireBaseVersion()}")
...
dependencies {
    ...
    "integrationTestImplementation"(libs.spring.data.gemfire.test.framework)
}
