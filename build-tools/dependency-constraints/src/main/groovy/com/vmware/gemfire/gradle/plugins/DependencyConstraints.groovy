 ...
 * buildscript {} configuration in the root project's build.gradle. */
  ...
  static private Map<String, String> initExternalDependencies() {
    ...
    depVersionMapping.put("logbackVersion", "1.4.5")
    ...
    depVersionMapping.put("slf4jVersion", "2.0.4")
    depVersionMapping.put("springSecurityVersion", "6.0.4")
    depVersionMapping.put("springShellVersion", "1.2.0.RELEASE")
    depVersionMapping.put("findbugsVersion","3.0.2")
    depVersionMapping.put("springVersion","6.0.10")
    depVersionMapping.put("springBootVersion","3.0.8")
    depVersionMapping.put("springDataCommonsVersion","3.0.7")
    depVersionMapping.put("springSessionVersion","3.0.2")
    depVersionMapping.put("multithreadedtcVersion","1.01")
  ...
  void apply(Project project) {
    ...
    project.dependencies {
      ...
      constraints {
        ...
        api(group: 'com.vmware.gemfire', name: 'spring-test-gemfire-9.15-3.0', version: get('stgVersion'))
