 ...
 * buildscript {} configuration in the root project's build.gradle. */
  ...
  static private Map<String, String> initExternalDependencies() {
    ...
    depVersionMapping.put("jakartaServletApiVersion", "4.0.4")
    depVersionMapping.put("jakartaServletJspJstlApiVersion", "1.2.7")
    depVersionMapping.put("javaxAnnotationsApiVersion", "1.3.2")
    ...
    depVersionMapping.put("springSecurityVersion", "5.7.9")
    depVersionMapping.put("springShellVersion", "1.2.0.RELEASE")
    depVersionMapping.put("findbugsVersion","3.0.2")
    depVersionMapping.put("springVersion","5.3.28")
    depVersionMapping.put("springBootVersion","2.7.13")
    depVersionMapping.put("springDataCommonsVersion","2.7.13")
    depVersionMapping.put("springSessionVersion","2.7.2")
    depVersionMapping.put("multithreadedtcVersion","1.01")
  ...
  void apply(Project project) {
    ...
    project.dependencies {
      ...
      constraints {
        ...
        api(group: 'javax.annotation', name: 'javax.annotation-api', version: get('javaxAnnotationsApiVersion'))
